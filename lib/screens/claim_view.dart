...
class _EditClaimScreenState extends State<EditClaimScreen> {
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 10),
                  ...fieldNameMapping.keys.map((key) {
                    final value = fieldNameMapping[key];
                    return editMode
                        ? _buildEditableField(value, claimData[value])
                        : _InfoRow(
                      title: key,
  ...
  Widget _buildEditableField(String field, String initialValue) {
...
class _InfoRow extends StatelessWidget {
  ...
  _InfoRow(
      {required this.title, required this.value, required this.isProvided});
